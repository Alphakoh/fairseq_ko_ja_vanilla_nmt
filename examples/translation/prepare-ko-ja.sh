...
# gdown 'https://drive.google.com/file/d/1a3_B185qDJ-POxr_IMVzROu96GEHEuxI/view?usp=sharing'
pip install gdown
gdown --id 1a3_B185qDJ-POxr_IMVzROu96GEHEuxI --output $orig/ja-ko.json
if [ $? -ne 0 ]; then
